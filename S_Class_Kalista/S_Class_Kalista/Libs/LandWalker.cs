...
namespace S_Class_Kalista
{
    ...
    /// </summary>
    public static class LandWalker
    {

        private static readonly string _orbwalkerName = "LandWalker";
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                /* Drawings submenu */
                var drawings = new Menu($"{_orbwalkerName}.Drawings", "Drawings");
                ...
                /* Misc options */
                var misc = new Menu($"{_orbwalkerName}.Misc", "Misc");
                misc.AddItem(
            ...
            public virtual AttackableUnit GetTarget()
            {
                ...
                if (ActiveMode == OrbwalkingMode.LaneClear || ActiveMode == OrbwalkingMode.Mixed ||
                    ActiveMode == OrbwalkingMode.LastHit || (Properties.MainMenu.Item("bUseMinionComboWalk").GetValue<bool>() && ActiveMode == OrbwalkingMode.Combo))
                {
                    var MinionList =
                        ObjectManager.Get<Obj_AI_Minion>()
                            .Where(
                    ...
                    foreach (var minion in MinionList)
                    {
                        ...
                        if (minion.Team != GameObjectTeam.Neutral && (_config.Item($"{_orbwalkerName}.AttackPetsnTraps").GetValue<bool>() && minion.BaseSkinName != "jarvanivstandard" || MinionManager.IsMinion(minion, _config.Item($"{_orbwalkerName}.AttackWards").GetValue<bool>())))
                        {
                            if (predHealth <= 0)
                            {
