...
namespace SCore
{
    class Vector : Base
    {
        ...
        public static List<Obj_AI_Base> GetDashObjects(IEnumerable<Obj_AI_Base> predefinedObjectList = null)
        {
            ...
            return objects.Where(o => IsLyingInCone(o.ServerPosition.To2D(), apexPoint, Player.ServerPosition.To2D(), System.Math.PI)).OrderBy(o => o.Distance(apexPoint, true)).ToList();
        }
    }
}
